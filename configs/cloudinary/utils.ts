...
export const uploadImage = async (
  ...
  const uploadOptions = CLOUDINARY_UPLOAD_OPTIONS[uploadType.toUpperCase() as keyof typeof CLOUDINARY_UPLOAD_OPTIONS];
...
export const getImageUrl = (publicId: string, transformations?: CloudinaryTransformations): string => {
