    ...
    <nav className="sticky top-0 z-40 bg-white border-b border-slate-100">
      <div className="mx-auto flex w-[90%] max-w-400 items-center justify-between px-6 lg:px-8 py-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link
            href="/landing/about"
            className={getLinkClass("/landing/about")}
          >
            Tentang Kami
          </Link>
          <Link
            href="/landing/features"
            className={getLinkClass("/landing/features")}
          >
            Fitur
          </Link>
          <Link
            href="/landing/how-it-works"
            className={getLinkClass("/landing/how-it-works")}
          >
            Cara kerja
          </Link>
          <Link
            href="/landing/pricing"
            className={getLinkClass("/landing/pricing")}
          >
            Harga
          </Link>
        </div>
