        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 mx-auto items-start">
          ...
          <div>
            ...
            <p className="text-slate-500 text-lg leading-relaxed mb-12">
              Tim kami siap menjawab pertanyaan Anda seputar platform, fitur, atau cara memulai digitalisasi bisnis UMKM Anda.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-slate-900">hello@produkita.id</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-0.5">WhatsApp</p>
                  <p className="font-semibold text-slate-900">+62 812-3456-7890</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-0.5">Lokasi</p>
                  <p className="font-semibold text-slate-900">Jakarta Selatan, Indonesia</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <form className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="name" className="text-xs font-semibold text-slate-700">Nama</label>
                  <input 
                    type="text" 
                    id="name"
                ...
                <div className="space-y-2">
                  <label htmlFor="company" className="text-xs font-semibold text-slate-700">Nama Bisnis</label>
                  <input 
                    type="text" 
                    id="company"
              ...
              <div className="space-y-2">
                <label htmlFor="message" className="text-xs font-semibold text-slate-700">Pesan</label>
                <textarea 
                  id="message"
                  rows={4}
              ...
              <Button type="button" className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-xl py-6 font-bold shadow-md shadow-blue-600/20">
                Kirim Pesan
              </Button>
            </form>
          </div>
