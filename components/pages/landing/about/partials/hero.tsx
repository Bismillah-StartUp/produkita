      ...
      <div className="mx-auto w-[90%] max-w-400 px-6 lg:px-8 relative z-10">
        <div className="text-center mx-auto mb-20">
          ...
          <p className="text-lg text-slate-500 max-w-3xl mx-auto leading-relaxed">
            Produkita lahir dari keinginan membantu pelaku UMKM mengelola produk
            dan bisnis mereka secara digital dengan mudah.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mx-auto items-stretch">
          <div className="bg-white rounded-3xl p-10 border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:border-blue-200 transition-all duration-300 flex flex-col gap-6">
            ...
            <p className="text-slate-600 leading-relaxed text-[15px]">
              Menjadi platform digital yang dipercaya oleh UMKM Indonesia untuk
              mengelola dan mengembangkan produk mereka secara mandiri.
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-10 border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-orange-900/5 hover:border-orange-200 transition-all duration-300 flex flex-col gap-6">
            ...
            <p className="text-slate-600 leading-relaxed text-[15px]">
              Memudahkan pelaku UMKM mengelola produk, sertifikasi, dan keuangan
              bisnis secara digital tanpa perlu latar belakang teknologi, dengan
