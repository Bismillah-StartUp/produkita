...
const VALUES_DATA = [
  {
    ...
    description:
      "Setiap fitur kami dirancang khusus untuk memenuhi kebutuhan nyata pelaku UMKM Indonesia.",
    icon: Target,
    highlight: false,
  },
  {
    ...
    description:
      "Kami percaya bahwa digitalisasi harus dapat diakses oleh semua kalangan, tanpa memandang latar belakang teknis.",
    icon: Heart,
    highlight: false,
  },
  {
    ...
    description:
      "Kami terus berinovasi dan mengembangkan solusi baru sesuai perkembangan kebutuhan industri.",
    icon: Lightbulb,
    highlight: false,
  },
  {
    ...
    description:
      "Kami membangun ekosistem UMKM yang saling mendukung dan berkembang bersama.",
    icon: Users,
    highlight: false,
  },
];
