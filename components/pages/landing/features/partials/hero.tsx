      ...
      <div className="mx-auto w-[90%] max-w-[1600px] px-6 lg:px-8">
        ...
        <div className="text-center mx-auto mb-16">
          ...
          <p className="text-lg text-slate-500 max-w-3xl mx-auto leading-relaxed">
            Semua yang dibutuhkan pelaku UMKM untuk sertifikasi, analitik, dan keamanan data — dalam satu platform terintegrasi.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-10 md:gap-20 border-t border-slate-100 pt-10">
          <div className="text-center">
            ...
            <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Fitur Utama</p>
          </div>
          
          <div className="text-center">
            <h4 className="text-3xl font-bold text-blue-600 mb-1">70%</h4>
            <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Lebih Cepat</p>
          </div>
          
          <div className="text-center">
            <h4 className="text-3xl font-bold text-blue-600 mb-1">24/7</h4>
            <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Support</p>
          </div>
          
          <div className="text-center">
            <h4 className="text-3xl font-bold text-blue-600 mb-1">28+</h4>
            <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Parameter Uji</p>
          </div>
        </div>
